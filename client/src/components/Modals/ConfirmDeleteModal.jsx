    ...
    >
      <DialogTitle sx={{
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            <Typography variant="h5" sx={{ fontWeight: 600, color: hasActiveOrders ? 'warning.dark' : 'error.dark' }}>
              {hasActiveOrders ? 'Cannot Delete Product' : 'Confirm Delete'}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {hasActiveOrders ? 'Product has active orders' : 'This action cannot be undone'}
            </Typography>
          </Box>
        </Box>
      </DialogTitle>
      <DialogContent sx={{ p: 3 }}>
        {hasActiveOrders ? (
          <Box>
            ...
            >
              <Typography variant="body2" fontWeight={600}>
                This product cannot be deleted because it has {activeOrdersCount} active order(s).
              </Typography>
            </Alert>
            ...
            >
              ...
              <Alert severity="info" sx={{ borderRadius: 2 }}>
                <Typography variant="body2">
                  <strong>Recommended:</strong> Mark the product as "Unavailable" instead. This hides it from customers while preserving order data.
                </Typography>
              </Alert>
            </Paper>
          </Box>
          ...
          <Box>
            ...
            >
              You are about to mark this product as unavailable. It will be removed from the store and customers won't be able to purchase it.
            </Alert>
            ...
            <Alert severity="info" sx={{ mt: 3, borderRadius: 2 }}>
              <Typography variant="body2">
                ℹ️ Product will be marked as unavailable instead of being permanently deleted. This preserves order history.
              </Typography>
            </Alert>
          </Box>
        )}
