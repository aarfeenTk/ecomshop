...
import type { CartItem, Product, OrderFormData } from "../../types";
...
const Checkout: React.FC = () => {
  ...
  const handleSelectChange = (
    event: SelectChangeEvent<"Cash on Delivery" | "Bank Transfer">,
  ): void => {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      setErrors({ submit: (error as string) || "Failed to create order" });
    }
  };
