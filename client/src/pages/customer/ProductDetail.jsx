      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <CardMedia
              component="img"
              image={product.image || 'https://via.placeholder.com/600x600?text=Product'}
              alt={product.name}
              sx={{
                height: 500,
                width: '100%',
          ...
          <Box sx={{ display: 'flex', gap: 1, mt: 2, overflowX: 'auto' }}>
            {[product.image].map((img, index) => (
              ...
              >
                <CardMedia
                  component="img"
                  image={img || 'https://via.placeholder.com/80x80?text=Product'}
          ...
          <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="h6" color="text.secondary">
                Total Price:{' '}
                <Typography component="span" variant="h5" color="primary.main" sx={{ fontWeight: 700 }}>
